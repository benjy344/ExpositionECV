...
urlpatterns = [
    ...
    url(r'^artwortks/$', views.getallartwortks, name='get all artworks'),
    url(r'^artwortks/search$', views.getallartwortkbyparams, name='search for an artworks from parameters'),
    url(r'^artwortks/(?P<pk>[0-9]+)/$', views.getartwortk, name='search for an artworks from id'),
    url(r'^artwortks/(?P<pk>[0-9]+)/addlike$', views.addlike, name='add a like on artwork with a token'),
    url(r'^artwortks/(?P<pk>[0-9]+)/removelike', views.removelike, name='same as like but remove'),
    ...
    url(r'^rooms/(?P<pk>[0-9]+)/artwortks/$', views.getartwortkbyroom, name='get all artworks by rooms with an id'),
